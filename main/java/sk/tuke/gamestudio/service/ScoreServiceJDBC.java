...
public class ScoreServiceJDBC implements ScoreService {
    ...
    public List<Score> getAllScores(String game) {
        final String selectAllScoresQuery = "SELECT game, player, points, playedOn FROM score WHERE game = ? ORDER BY points DESC";
        try (Connection connection = DriverManager.getConnection(URL, USER, PASSWORD);
             PreparedStatement statement = connection.prepareStatement(selectAllScoresQuery)) {
